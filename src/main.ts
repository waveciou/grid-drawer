...
(function (Velocity) {
  ...
  class GridDrawer {
    ...
    constructor(el: string, options?: iConfig) {
      ...
      this.GD_CONTAINER = document.querySelector(el) as HTMLElement;
      ...
      this.GD_INSIDES = document.querySelectorAll(
        `${this.EL} ${classNameInside}`
      );
      this.GD_OUTSIDES = document.querySelectorAll(
