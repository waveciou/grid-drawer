...
export default function controlAnimation (element: HTMLElement):void {
  ...
  if (this.GD_CONTAINER.querySelectorAll('.is-open').length) {
    ...
    setSidePosition.call(this, $allSides, config.begin, config.end, config.offset);
  } else {
