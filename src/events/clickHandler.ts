...
export default function clickHandler(this: any, e: MouseEvent) {
  const isAnimating = Array.prototype.some.call(
    this.GD_INSIDES,
    (element: HTMLElement) => {
  ...
  const $item: HTMLElement = getParents(element, "gd__item") as HTMLElement;
  ...
  window.innerWidth > 1024
    ? controlAnimation.call(this, $item)
    : controlSlide.call(this);
  return false;
}
